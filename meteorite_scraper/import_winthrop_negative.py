#!/usr/bin/env python3
"""
One-off import of Winthrop negative sample photos (no meteorite present).

Copies images from the source directory into the DB with:
  meteorite_name  = Winthrop_Negative_<n>
  in_situ         = True
...
SRC_DIR = Path(r"C:\Users\charl\OneDrive\Documents\_Projects\Meteorites\Negative_Photos")
